...
import { GoPrimitiveBot, GoPrimitiveDot } from 'react-icons/go'
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center ' >
          <div className='flex justify-between items-center' >
            <div>
              ...
              <p className='text-2xl' >$6,789,232</p>
            </div>
          </div>
          <div className=' mt-6' >
            <Button color='white'
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780' >
          ...
          <div className='mt-10 flex flex-wrap justify-center gap-10' >
            <div className='border-color m-4 pr-10 border-r-1' >
              <div>
                <p>
                  <span className='text-3xl font-semibold' >$94,557</span>
              ...
              <div className='mt-8' >
                <p>
                  <span className='text-3xl font-semibold' >$48,557</span>
                </p>
